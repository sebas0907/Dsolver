...
namespace Dsolver_RK4//solve a coupled spring-mass system:
{
        class Program
        {
            // Declaration of one or many differential equations as single functions of the arguments (x1,x2):
